  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative max-h-svh w-full max-w-lg p-6 bg-white/80 border border-white/20 backdrop-blur-lg text-black rounded-2xl shadow-lg"
      ...
      >
        ...
        <div className="max-h-[90svh] overflow-y-scroll">
          ...
          <p className="text-sm mb-2 text-black/60">
            {selectedExperience.period} &bull; {selectedExperience.models}{' '}
            &bull; {selectedExperience.type}
          </p>
